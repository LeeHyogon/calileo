...
class SubCreateEvent extends Component{
  constructor(props) {
    super(props);
    this.state = {
      startDate :this.props.createSubNewTime,
...
handleClose = () => {this.props.eventSubClose()}
handleConfirm = () => {
this.props.enlistSubNew({eventDetail :this.state.eventDetail, startTime : this.state.startDate, endTime : this.state.endDate})
}
makeEvent = e => {
